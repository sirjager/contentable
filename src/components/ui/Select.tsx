...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-10 w-full items-center justify-between rounded-buttons border border-border-light bg-transparent px-3 py-2 text-sm text-color-secondary-light placeholder:text-color-secondary-light  disabled:cursor-not-allowed disabled:opacity-50 dark:border-border-dark dark:text-color-secondary-dark dark:placeholder:text-color-secondary-dark",
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Label
    ref={ref}
    className={cn(
      "py-1.5 pl-8 pr-2 text-sm font-semibold text-color-primary-light dark:text-color-primary-dark",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <SelectPrimitive.Separator
    ref={ref}
    className={cn("-mx-1 my-1 h-px bg-primary-light dark:bg-primary-dark", className)}
    {...props}
  />
));
